...
export const enum IpcEvents {
    ...
    GET_CSS_SNIPPET_LIST = "VencordGetCssSnippetList",
    GET_CSS_SNIPPET_ITEM = "VencordGetCssSnippetItem",
    SET_CSS_SNIPPET_ITEM = "VencordSetCssSnippetItem",
    DELETE_CSS_SNIPPET = "VencordDeleteCssSnippet",
    OPEN_CSS_SNIPPET_EDITOR = "VencordOpenCssSnippetEditor",
    GET_CSS_SNIPPETS = "VencordGetCssSnippets",
    SET_CSS_SNIPPETS = "VencordSetCssSnippets",
